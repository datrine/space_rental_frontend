...
let IndexBody = () => {
    return <>
        <Container maxWidth className="mt-5" style={{
            padding: 0,
            height: 700, backgroundImage: "url('hp_share_apart.png')", backgroundRepeat: "no-repeat",
            backgroundPosition: "center", backgroundSize: "cover"
        }} >
            <Container maxWidth style={{ paddingTop: 100, height: 700, backgroundColor: "rgba(0,128,0,0.5)" }} >
...
let Tiles = () => {
    ...
    return <>
        ...
        <Container className="w3-card"
            style={{
                width: "80%", margin: "10%", borderStyle: "solid",
            ...
            >
                <Grid item xs={10} sm={11} >
                    <h4 style={{ fontWeight: "bold" }}>
                        {titleOf.length > 44 ? (titleOf.substring(0, 40) + "...") : titleOf}</h4>
                    <p>{textOf}</p>
                </Grid>
